...
public class Main {
    ...
    static int readSize(String nameSize) {
    ...
    static int checkIntNumber(String nameSize) {
    ...
    static boolean checkCorrectNumber(int size) {
        if (size >= 1) {
            return true;
        }
        return false;
    ...
    static void printFigure(int h, int w) {
        for (int repeat = h; repeat >= 1; repeat--) {
